...
3 schools dropped the program by end of kindergarten

```{r}
dropk = STAR[!is.na(STAR$g1tmathss), ]
dim(table(dropk$gkschid))
```
...
STAR_medn_aov = aov(medn_score ~ g1classtype + as.factor(g1surban) + g1schid, data = STARt)
